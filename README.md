...
<p align="center">
  ...
  <img src="Docs/Screenshots/favorite-characters.png" width="250" alt="Favorite characters highlight">
...
```bash
git clone https://github.com/LukaszSzelag/RickAndMortyWiki.git
```
