...
#Playground {
    ...
    let page: PageResponseDTO<CharacterDTO> = try await apiClient.request(endpoint: GetItemsPage(page: 1, filters: [:]))
    //    let page = try await characterRepository.fetchCharacters(page: 1, filters: [:])
    //}
}
